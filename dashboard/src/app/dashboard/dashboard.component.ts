...
export class DashboardComponent implements OnInit {
  ...
  exibirPieChart(): void {
    ...
    const chart = new google.visualization.PieChart(el); //passa a divi onde será exibido

    chart.draw(this.obterDataTable(), this.obterOpcoes()); /// drow é o comondo que avi desenhar o grafico
  }
